"use strict";
// nav.ts — renders the shared sidebar into <div id="sidebar-root"> on every page.
// Depends on DashApp from shared.ts (load shared.js first).
const NAV_LINKS = [
  {
    id: "dashboard",
    href: "index.html",
...
// Ambient idle particles drifting up behind everything — purely decorative.
